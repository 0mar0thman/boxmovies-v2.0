const apiKey = "724fa79eddb78094bf31242df4a56d93"; // Replace with your TMDB API key
const apiUrl = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&language=en&sort_by=popularity.desc&page=0&with_genres=27`;
const moviesPerPage = 8;
const totalPages = 100; // Assume total 100 pages for simplicity
let currentPage = 1;
let moviesList = [];
  ...
  if (event.target.closest(".btn-card")) {
    ...
    if (movie) {
      ...
      fetchYouTubeTrailer(movie.id, (videoUrl) => {
        ...
        window.location.href = "http://127.0.0.1:5500/pages/pageMove.html";
      });
    }
  }
});
